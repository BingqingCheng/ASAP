...
class TestKPCA(asap_testobject.ASAPlibTestCase):
    def setUp(self):
        ...
        # references:
        self.ref_pvec_train = np.array([[-3.22200775e+00, 9.59025264e-01, 2.57486105e-03, -1.31988525e-02],
        ...
        self.ref_pvec_test = np.array([[-3.35908103e+00, 1.41343698e-01, 1.47953272e-01, 3.27377319e-02],
    ...
    def test_fit_and_transform(self):
        ...
        # check result
        self.assertArrayAlmostEqual(pvec_train, self.ref_pvec_train, tol=5e-4)

        # transform the test
        pvec_test = kpca_obj.transform(self.K_test)
        self.assertKernelsNotChanged()
        self.assertArrayAlmostEqual(pvec_test, self.ref_pvec_test, tol=5e-4)
