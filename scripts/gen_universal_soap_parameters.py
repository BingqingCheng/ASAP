...
The command 
gen_universal_soap_parameters.py --Zs 5 32
...
def main(Zs, soap_n, soap_l, length_scales, multisoap, sharpness, verbose, outfile):
...
if __name__ == '__main__':
    ...
    main(args.Zs, args.n, args.l, length_scales, args.multisoap, args.sharpness, args.verbose, args.output)
